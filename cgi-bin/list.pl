...
print "<html lang=\"es\"><head><title>Listado de Páginas</title><link rel=\"stylesheet\" href=\"style.css\"></head><body>";
...
# Botón para agregar nueva página, fuera del div 'boton'
